      ...
      <div className="w-full max-w-[440px]">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input placeholder="Satoshi" value={form.firstName} onChange={set('firstName')} required />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5">Last name</label>
                <Input placeholder="Nakamoto" value={form.lastName} onChange={set('lastName')} required />
              </div>
            </div>
            ...
            <div>
              ...
              <Input type="password" placeholder="Create a strong password" value={form.password} onChange={set('password')} required />
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link to="/signin" className="text-[#0052FF] font-semibold hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
